"""
Register the capital_bfsi datasource and auto-ingest the capital_position
model into the running SLayer instance.

Run once after bootstrap_bfsi.py, before running any agent.
...
if not os.path.exists(db_path):
    print(f"ERROR: {db_path} not found — run bootstrap_bfsi.py first.")
    sys.exit(1)
